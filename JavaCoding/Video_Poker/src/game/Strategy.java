...
class Strategy {
	...
	public static String Advice(Hand hand, Credit credit, PayTable107 paytable, Statistics statistics){
		String Advice;
		RetVerify Ret;
		int vec[]=new int[4];
		...
		}else if(((Ret=Verify107.Flush(hand)).getnRet()==2)&&(Verify107.HighCardInNCards(Ret, hand, 4)==0)){//4 to inside straight with 0 highcards
			return Strategy.StringfyAdvice(Ret, 4);
		}else{
			return "h";
		}
